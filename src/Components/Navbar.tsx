  ...
  return (
    <div className='absolute h-screen w-screen'>
       ...
       <h1 className='h-full w-full flex items-end justify-center pb-5 md:pb-20 drop-shadow-lg'>
        ...
        <div className='flex w-fit bg-[#051923] rounded-full py-1 px-1 text-xs gap-1 sm:py-2.5 sm:px-3.5 sm:gap-4 sm:text-md md:py-3 md:px-4 md:gap-5 md:text-lg font-semibold'>
